...
import GenerateBillDialog from "../../../components/TableFooter/MOP_DialogBox";// Assuming you already have this component

const GenerateBill = ({ openDialog, setOpenDialog, handleGenerateBillClick }) => {
  return (
