...
import BasicProductDetails from "../AddNewProduct/ProductFormComponents/BasicProductDetails";
import TaxProductDetails from "../AddNewProduct/ProductFormComponents/TaxProductDetails";

const EditProductForms = (props:any) => {
